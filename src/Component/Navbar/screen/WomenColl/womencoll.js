...
import './womencoll.css'
import StarRateIcon from '@mui/icons-material/StarRate';
import StarOutlineIcon from '@mui/icons-material/StarOutline';
import productDetail from './womencoll.json';
            ...
            <div className="productsPageMain">
                ...
                <div className="productsPageMainRight">
                    <div className="productsPageMainRightTopBanner">
                        1-5 of 5 results for <span className='productsPageMainRightTopBannerSpan'>Women's collection</span>
                    </div>
                    ...
                    <div className="itemsImageProductPage">
...

                        {
                          ...
                          <div className="itemsImageProductPageone" key={item.iddn}>
